        ...
        while True:
            ...
            if msg is None:
                ...
                try:
                    ...
                    # Commiting before producing ensures that if a voter tries to vote twice
                    # the DB will throw a unique key error which be caught and skipped
                    # and the producing will not happen
                    conn.commit()
